...
public class Main extends Application {
    ...
    public void start(Stage stageMain) throws Exception
    {
        ...
        /*switch to check OS names, as setResizable does not work with some operating systems, such as linux.
        By default we want to do it the longer method with more set actions, however if we can just use set
