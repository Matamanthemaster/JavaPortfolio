...
public class Controller
{
    ...
    static int taxPercentage = 30; //percentage of tax for calculation of net pay.
    ...
    @FXML private TabPane tabpaneEmployees; //Tabs stored in here, we can add new employees which generates a tab added into the pane.
    @FXML private Text lblDispNoRoom; //Only shown when noEmployees == employeeTabs.length
    ...
    public void btnAddEmployeePressed()
    {
        ...
        employeeTabs[noEmployees] = new Employee(this, tabpaneEmployees, noEmployees);
    ...
    public void removeEmployeeTab(int id)
    {
